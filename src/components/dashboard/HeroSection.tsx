...
const HeroSection: React.FC = () => {
  ...
  return (
    <section className="relative bg-gradient-to-br from-white via-[#faf9fb] to-[#ebe9f0] overflow-hidden min-h-[50vh] md:min-h-[25vh] lg:min-h-[90vh] xl:min-h-[80vh] 2xl:min-h-[85vh] m-0 pt-0">
      {/* Top-left curved line */}
      <img
        src={curvedLine}
        alt="curvedLine "
        className="absolute top-0 left-0 w-[100px] md:w-[120px] lg:w-[160px] xl:w-[170px] 2xl:w-[190px] z-0"
        data-aos="fade-right"
      />
      ...
      <div className="container mx-auto flex flex-col md:flex-row items-center justify-between px-6 md:px-20 lg:px-10 xl:px-22 2xl:px-34 pt-0 md:pt-16 relative z-10">
        ...
        <div className="md:w-1/2 text-center md:text-left mb-10 md:mb-20 mt-10 md:-mt-4 lg:-mt-18 xl:-mt-14 2xl:-mt-8 relative">
          <h1
            className="text-[30px] md:text-[24px] lg:text-[35px]  xl:text-[40px] 2xl:text-[45px] font-normal text-gray-900 leading-tight md:leading-snug mb-3 relative"
            data-aos="fade-right"
          >
            Selamat
        ...
        <div className="w-3/4 md:w-1/2 lg:w-3/4 relative flex justify-center items-center">
          ...
          <img
            src={dotsPattern}
            alt="Dots"
            className="absolute -top-[25px] md:-top-[15px] lg:top-[20px] xl:top-[25px] -right-[15px] md:-right-[18px] lg:right-[70px] xl:right-[100px] 2xl:right-[125px] w-[480px] z-0 md:w-[360px] lg:w-[370px] xl:w-[400px] 2xl:w-[490px] spin-reverse"
            data-aos="fade-up"
          />
          ...
          {/* Arrow */}
          <img src={arrow} alt="Arrow" className="absolute right-[150px] md:right-[165px] lg:right-[350px] xl:right-[415px] 2xl:right-[520px] -top-[10px] md:-top-[16px] lg:top-[50px] xl:top-[60px] 2xl:top-[60px] w-[70px] md:w-[70px] lg:w-[70px] xl:w-[80px] 2xl:w-[90px] rotate-25 md:rotate-20 lg:rotate-1 xl:rotate-1" data-aos="fade-left" />
