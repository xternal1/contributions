...
import masjid from "/public/images/masjid.jpg";
...
const EventCertificatePage = () => {
    ...
    return (
        <div className="min-h-screen bg-gray-50 dark:bg-[#0D0D1A] pb-20 transition-colors duration-500">
            ...
            <div className="max-w-6xl mx-auto px-6 md:px-12 py-8 lg:pl-27 mt-6">
                <div className="grid grid-cols-1 lg:grid-cols-[1.9fr_1fr] gap-8">
                    ...
                    <div>
                        <section className="mb-8">
                            ...
                            <div className="flex flex-wrap items-center justify-between gap-4 text-[13px] text-gray-600 dark:text-gray-400 transition-colors duration-500">
                                {/* Kiri: Profil & jumlah siswa */}
                                <div className="flex items-center gap-4">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <span className="dark:text-white">Syekh holil</span>
                                    </div>
                                ...
                                {/* Kanan: Tombol */}
                                <button
                                    className="w-fit relative group overflow-hidden font-sans font-semibold text-[11px] py-1.5 px-3 rounded-full flex justify-center gap-2 border transition-all duration-500 ease-in-out shadow-[2px_2px_0px_0px_rgba(0,0,0,0.5)] hover:shadow-[1px_1px_0px_0px_rgba(0,0,0,0.2)] active:translate-y-0.5 bg-white dark:bg-gray-800 border-purple-600 dark:border-purple-500 text-purple-600 dark:text-purple-400 hover:bg-purple-600 hover:text-white dark:hover:bg-purple-700 transition-colors duration-500"
                                >
                                    <span className="absolute inset-0 bg-gradient-to-r from-purple-600 to-purple-700 opacity-0 transition-opacity duration-500 group-hover:opacity-100"></span>
                                    <span className="relative z-10">Lihat Event</span>
                                </button>

                                {/* Judul & Deskripsi di bawah */}
                                <h1 className="text-[15px] md:text-[17px] font-bold text-gray-800 dark:text-white leading-snug mb-3 text-left w-full transition-colors duration-500">
                                    Motivasi kehidupan dalam Al-Qur'an
                                </h1>
                                <p className="text-gray-600 dark:text-gray-400 mb-3 text-[13px] text-left w-full transition-colors duration-500">
                                    22. Al-Mumtahanah (60:8)
                                    "Allah tidak melarang kamu untuk berbuat baik dan berlaku adil terhadap orang-orang yang tidak memerangimu karena agama dan tidak mengusirmu dari negerimu. Sesungguhnya Allah menyukai orang-orang yang adil."
                                    Arabic: لَا يَنْهَاكُمُ اللَّهُ عَنْ الَّذِينَ لَمْ يُقَاتِلُوكُمْ فِي الدِّينِ وَلَمْ يُخْرِجُوكُمْ مِنْ دِيَارِكُمْ أَنْ تَبَرُّوهُمْ وَتُقْسِطُوا إِلَيْهِمْ إِنَّ اللَّهَ يُحِبُّ الْمُقْسِطِينَ
                                </p>
                            </div>
                        ...
                        <section className="text-gray-700 dark:text-gray-300 leading-relaxed text-left transition-colors duration-500">
                            ...
                            <div className="overflow-x-auto">
                                {/* Bungkus tabel dengan border yang sama */}
                                <div className="border border-gray-300 dark:border-purple-900 rounded-lg overflow-hidden transition-colors duration-500">
                                    <table className="w-full border-collapse text-[12px]">
                                        <thead>
                                            <tr className="bg-purple-600 dark:bg-purple-800">
                                                <th className="border border-gray-300 dark:border-gray-600 px-3 py-2 text-center font-semibold text-white">
                                                    Tanggal & Waktu
                                                </th>
                                                <th className="border border-gray-300 dark:border-gray-600 px-3 py-2 text-center font-semibold text-white">
                                                    Sesi
                                        ...
                                        <tbody>
                                            <tr className="hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors duration-300">
                                                <td className="border border-gray-300 dark:border-gray-700 px-3 py-2 text-center dark:text-white">
                                                    <div className="font-medium text-md">13:00 - 13:30</div>
                                                    <div className="text-gray-500 dark:text-gray-400 text-xs">27, September 2025</div>
                                                </td>
                                                <td className="border border-gray-300 dark:border-gray-700 px-3 py-2 dark:text-white">
                                                    Opening Dicoding Developer Coaching
                                                </td>
                                                <td className="border border-gray-300 dark:border-gray-700 px-3 py-2 dark:text-white">
                                                    <div className="font-medium">Mohammad Arif</div>
                                                    <div className="text-gray-600 dark:text-gray-400 text-[11px]">Curriculum Developer</div>
                                                </td>
                                            </tr>

                                            <tr className="hover:bg-gray-50 dark:hover:bg-gray-800 bg-gray-50 dark:bg-purple-900 transition-colors duration-300">
                                                <td className="border border-gray-300 dark:border-gray-700 px-3 py-2 text-center dark:text-white">
                                                ...
                                                <td className="border border-gray-300 dark:border-gray-700 px-3 py-2 dark:text-white">
                                                    <div className="font-medium">Arif Racing</div>
                                                    <div className="text-gray-600 dark:text-gray-400 text-[11px]">Curriculum Developer</div>
                                                </td>
                                            </tr>
                                            ...
                                            <tr className="hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors duration-300">
                                                <td className="border border-gray-300 dark:border-gray-700 px-3 py-2 text-center dark:text-white">
                                                    <div className="font-medium">13:00 - 16:00</div>
                                                    <div className="text-gray-500 dark:text-gray-400 text-xs">28, September 2025</div>
                                                </td>
                                                <td className="border border-gray-300 dark:border-gray-700 px-3 py-2 dark:text-white">
                                                    Pembahasan materi 'Training dan Deployment Model Machine Learning dengan Google Cloud'
                                                </td>
                    ...
                    <aside>
                        <div className="w-[250px] sticky top-25 bottom-20 h-fit p-2 mx-auto lg:mx-0">
